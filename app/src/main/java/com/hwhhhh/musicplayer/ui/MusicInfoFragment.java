...
public class MusicInfoFragment extends Fragment {
    ...
    private void initView() {
        ...
        seekBar.setMax(musicService.getDuration());//获取真实长度
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) { //更新进度条
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                musicService.seekTo(seekBar.getProgress()); //获取当前进度值，并传给seekto调整进度
            }
        });

        ImageView imageView_back = view.findViewById(R.id.info_head_back);//回退
